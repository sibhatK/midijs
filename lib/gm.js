...
function checkFamily(program, family) {
    const familyIndex = gm.families.indexOf(family.toLowerCase());
 ...
 */
export function getProgram(instrument, family) {
    const program = gm.instruments.indexOf(instrument.toLowerCase());
 ...
 *                        exist or doesn't belong to the given family
 */
export function getInstrument(program, family) {
    const instrument = gm.instruments[program];
 ...
 *                        exist
 */
export function getFamily(instrumentOrProgram) {
    let program;
    let familyIndex;
    let family;
