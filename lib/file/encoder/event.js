...
import { MIDIEncoderError } from '../../error';
...
function encodeMetaEvent(event) {
    let length, cursor, eventData, value, rates;
...
export { encodeMetaEvent, encodeSysexEvent, encodeChannelEvent, encodeEvent };
